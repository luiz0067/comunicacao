...
<?php 
	...
	$sql 	= "select n.codigo,n.nome,n.imagem, n.empresa as id_empresa from novidades n  where (n.empresa='1')order by n.codigo desc limit ".(($pg-1)*$registros_pagina).",".$registros_pagina;
...
?>
   ...
   <div class="paginacaodepoimentos">
 	<?php 
		$sql								= " select count(n.codigo)as total from novidades n  where(n.empresa='1') order by n.codigo desc ";
		$result 							= mysql_query($sql,$link);
